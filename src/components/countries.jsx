...
import { Card,CardImg,CardTitle,CardBody,CardIcon } from './cards/card.jsx'
import Typography from './typography/typography.jsx';

const Countries = ({continent,setCardIndex,countries,countryData,setFavorite}) => {
  ...
  return(
    <>
        ...
        .map((item, index) => (
          <Card key={item.key} index={index} setCardIndex={setCardIndex}>
